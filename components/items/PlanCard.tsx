...
function PlanCard() {
  return (
        ...
        <Grid templateColumns={{ base: "1fr", md: "repeat(2, 1fr)" }} gap={4}  mt={10}>
          <GridItem>
            <Box padding={4} border={"1px solid grey"} borderRadius={30}>
              <HStack display={"flex"} justifyContent={"space-between"} mb={5} flexDirection={{ base: "column", md: "row" }}>
                <VStack align={"left"}>
                  <HStack>
              ...
              >
                <HStack flexDirection={{ base: "column", sm: "row" }}>
                  <Icon color={"red.700"} mt={-8} display={{smDown:'none' , md:'block'}}>
                    <FiAlertCircle />
                  </Icon>
